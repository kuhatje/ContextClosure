    ...
    <main className="grid" style={{ gap: 20 }}>
      <header className="card" style={{ background: "linear-gradient(135deg, #0ea5e9, #6366f1)" }}>
        ...
        <p style={{ marginTop: 8, color: "#0b1221" }}>
          A prototype that turns noisy repo + discussion signals into a weighted DAG (directed, acyclic graph) of
          documentation chunks, then solves for the maximum-value closure you can fit in context.
        </p>
        <p style={{ marginTop: 12, color: "#0b1221" }}>
          ...
          high-utility selections ready for the LLM (or the Oqoqo documentation engine, as postulated to exist in the problem statement.)
        </p>
